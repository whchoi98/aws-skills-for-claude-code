...
Install all skills from `.kiro/skills/` to `~/.claude/skills/` for Claude Code use.

## Step 1: Pre-Deploy Checks

1. Verify working tree is clean: `git status`
2. Verify `.kiro/skills/` has skills to install
...
- Verify all `.kiro/skills/` entries are present in `~/.claude/skills/`
